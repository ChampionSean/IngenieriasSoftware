...
public class LoginControlador {
    ...
    public String login(){
        ...
        try {
            ...
            mensaje = new FacesMessage(FacesMessage.SEVERITY_ERROR, "Usuario Inválido", null);
            faceContext.addMessage(null, mensaje);
            return "InicioIH";
        }
        Profesor login2;
        try {
            login2 = intermediario.getLoginProfesor(Integer.parseInt(usuario));
            System.out.println(login2);
            if (contrasenia.equals(login2.getPassword())) {
        ...
        Admin login3;
        try {
            login3 = intermediario.getLoginAdmin(Integer.parseInt(usuario));
            if (contrasenia.equals(login3.getPassword())) {
